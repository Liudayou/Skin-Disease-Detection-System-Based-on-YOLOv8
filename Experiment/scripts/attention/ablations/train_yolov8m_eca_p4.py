...
def main():
    ...
    p.add_argument("--model-cfg", default=str(PROJECT_ROOT/"scripts"/"models"/"generated"/"attention_ablations"/"yolov8m_eca_p4.yaml"))
    ...
    p.add_argument("--run-name", default="attention_ablation__ECA_P4_e100")
