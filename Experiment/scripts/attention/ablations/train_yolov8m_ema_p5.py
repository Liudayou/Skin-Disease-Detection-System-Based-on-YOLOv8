...
def main():
    ...
    p.add_argument("--model-cfg", default=str(PROJECT_ROOT/"scripts"/"models"/"generated"/"attention_ablations"/"yolov8m_ema_p5.yaml"))
    ...
    p.add_argument("--run-name", default="attention_ablation__EMA_P5_e100")
