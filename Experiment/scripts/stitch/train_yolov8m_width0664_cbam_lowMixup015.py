#!/usr/bin/env python3
"""Stitch方案：YOLOv8m width0664 + CBAM（lowMixup015）。

模型：
- `scripts/models/yolov8m_cbam_neck_width0664.yaml`（CBAM 插入 Neck；scales.m width=0.664）
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--model-cfg",
        type=str,
        default=str(PROJECT_ROOT / "scripts" / "models" / "yolov8m_cbam_neck_width0664.yaml"),
    )
    ...
    p.add_argument(
        "--run-name",
        type=str,
        default="yolov8m_w0664_cbam_ham_univ30_lowMixup015",
